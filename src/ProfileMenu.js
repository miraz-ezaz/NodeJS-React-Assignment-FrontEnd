...
const ProfileMenu = () => {
  return (
    <div className="profileMenu">
      <nav>
        <div>
          <button type="button" aria-label="Choose a language and currency" id="languageButton">
          ...
          <div>
            <button type="button" id="profileButton">
              ...
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation"
                  focusable="false"
                  style={{ display: 'block', height: '32px', width: '32px', fill: 'currentcolor', padding: '2px' }}>
                  <path
